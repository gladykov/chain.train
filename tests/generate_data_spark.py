...
class GenerateData:
    ...
    def generate_data(self):
        ...
        self.db.create_table(
            "test_schema",
            "test_table_1",
            [("column_name", "string"), ("column_name_1", "string"), ("column_name_2", "int"), ("column_name_3", "bigint")]
        )
        ...
        self.db.create_table(
            "test_schema",
            "test_table_2",
            [("column_name", "string"), ("column_name_1", "string"), ("column_name_2", "int"), ("column_name_3", "bigint"), ("column_name_4", "string")]
        )
